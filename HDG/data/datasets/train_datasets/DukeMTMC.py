...
class DukeMTMC(BaseTrainDataset):

    def __init__(self, cfg):
        self._dataset_dir = "DukeMTMC"
        self._domains = ["Camera1", "Camera2", "Camera3", "Camera4", "Camera5", "Camera6", "Camera7", "Camera8"]
        self._data_url = "https://drive.google.com/uc?id=1kbUaWjBbQ0l1Ee7kdKNl6vqzinHJ99lO"
        ...
        if not osp.exists(self._dataset_dir):
            dst = osp.join(dataset_path, "DukeMTMC.zip")
