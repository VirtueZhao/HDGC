    ...
    def read_test_data(self):
        ...
        def _build_datums(images):
            ...
            for img_path in images:
                ...
                domain_label = int(file_name.split("_")[1])
        ...
        query_images = glob.glob(osp.join(query_dir, "*.png"))
        self.test_info["Query"] = len(query_images)

        gallery_dir = osp.join(self._dataset_dir, "Gallery")
        gallery_images = glob.glob(osp.join(gallery_dir, "*.png"))
